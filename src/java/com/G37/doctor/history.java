...
public class history extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       Pappointmentdao d=new Pappointmentdao();
            ...
            out.println("</head>");
            out.println("<body>");
              out.println("<center><font  color=orange size=12><b><i>Patient Record</i></b></font></center>");
...
out.println("<input name=\"id\"  type=\"hidden\">");
           out.println("<input name=\"opn\" type=\"hidden\">");
                    ...
                    out.println("<tr bgcolor=\"brown\"><th>Name</th><th>Age</th><th>Sex</th><th>Test</th> <th>Report</th><th>Date</th><th>Remark</th><th>View Report</th></tr>");
                     recorddaos daos=new recorddaos();
                    ArrayList<record> ale=daos.findAllRecordDwise(id);
                    for(record c:ale){
